...
export const Card = ({ title, subtitle, Icon, href }: ContactsCard) => {
  return (
    <Link
      href={href}
      isExternal
      className="flex flex-col items-start p-4 rounded-xl text-color border-1 shadow-xl border-black relative overflow-hidden group bg-coal hover:opacity-100"
    >
      <div className="absolute inset-0 bg-success translate-y-[100%] group-hover:translate-y-[0%] transition-transform duration-300" />
